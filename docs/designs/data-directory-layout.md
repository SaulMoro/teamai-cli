...
mid-session) is reported once, where it started. A session written before that
...
since, is no scope's. The snapshots of what was already reported are per scope
