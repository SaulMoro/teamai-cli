...
- A placement record is dropped once its team file is neither on the default branch nor awaiting review in an open PR (the PR was closed unmerged, or the file was deleted later). `push` and `pull` both settle this before they read the records
