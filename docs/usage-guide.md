...
- An agent whose namespace is not active here is editable through its placement record, but only while your copy is in step with the team: if the team file changed since your last pull, push says so and asks you to pull first rather than write over it
